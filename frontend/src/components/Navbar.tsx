      ...
      <div className="navbar__inner">
        <div className="navbar__left">
          ...
          <label className="navbar__toggle" title="이미 확인한 공고 보지 않기">
            ...
            <div className={`toggle-switch${hideViewed ? " toggle-switch--on" : ""}`} onClick={toggleHideViewed}>
        ...
        <div className="navbar__right">
          <button className="navbar__saved-btn" onClick={onOpenSaved} title="저장함">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
            </svg>
            {newSaved > 0 && (
              <span className="navbar__badge">{newSaved > 99 ? "99+" : newSaved}</span>
            )}
          </button>
        </div>
      </div>
